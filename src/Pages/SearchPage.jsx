          ...
          {results.length > 0 ? (
            <ul className="space-y-6">
              {results.map((item) => (
                <li
                  key={item.id}
                  className="bg-gray-800 p-6 rounded-3xl shadow-lg flex items-center space-x-6 hover:bg-gray-700 transition-colors duration-200 ease-in-out cursor-pointer"
